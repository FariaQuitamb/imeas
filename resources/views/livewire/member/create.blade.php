                        ...
                        <div
                            ...
                            <form action="#" method="POST" class="space-y-6">
                                <header
                                    ...
                                    <label for="avatar" class="w-auto px-2 py-1 my-2 mr-2 transition duration-500 ease-in-out transform border rounded-md cursor-pointer text-slate-200 hover:text-slate-600 text-md focus:shadow-outline focus:outline-none focus:ring-2 ring-offset-current ring-offset-2 hover:bg-slate-100">

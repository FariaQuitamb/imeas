<div>
    <form autocomplete="off" wire:submit='verifyMember' method="POST" class="space-y-6">
        {{-- x-data x-mask.blocks="[1, 3, 3, 3]" --}}
        <div>
            <label for="text" class="block text-sm font-medium text-neutral-600">Número de membro, recebido por SMS
            </label>
            <input
                ...
                id="membernumber" autocomplete="false" type="text" wire:model.blur="code"
                placeholder="Informe o número de membro">
